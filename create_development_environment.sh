...
readonly API_CONTAINER_INSTALL_DEPENDENCIES_IP="192.168.20.16"
readonly API_PORT=8084
readonly API_MOCKUP_PORT=8085

# Configuración de APP
readonly APP_CONTAINER_NAME="${CONTAINERS[app]}"
readonly APP_CONTAINER_IP="192.168.20.19"
readonly APP_CONTAINER_INSTALL_DEPENDENCIES_IP="192.168.20.17"
readonly APP_PORT=8086
