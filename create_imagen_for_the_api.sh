...
echo $current_directory_of_the_bellesa_project
...
container_name_image_container_api=$name_project

# Paramos todos los contenedores
echo "Comenzando a parar todos los contenedores ...."

sudo docker stop $container_name_image_container_api
if [ $? -ne 0 ]; then
    echo ".....El Error response from daemon: No such container"
    echo ".....Se debe a que no existe el contenedor "$container_name_image_container_api
fi
...
sudo docker rm $container_name_image_container_api
if [ $? -ne 0 ]; then
    echo ".....El Error response from daemon: No such container"
    echo ".....Se debe a que no existe el contenedor "$container_name_image_container_api
fi
...
echo "......................................................................"
echo "Comenzando a crear el archivo create_containers_for_services_of_image_api.yml ...."
echo "......................................................................"
origen="$current_directory_of_the_bellesa_project/automate_image_for_api.yml"
destino="$current_directory_of_the_bellesa_project/create_containers_for_services_of_image_api.yml"

# Copiar el contenido del archivo de origen al archivo de destino
cp "$origen" "$destino"

sed -i "s|container_name: proyecto_api2|container_name: "$container_name_image_container_api"|g" "$destino"
sed -i "s|/home/juan/Documentos/proyecto_main|"$carpeta_raiz"|g" "$destino"

echo "Se termino de crear el archivo create_containers_for_services_of_image_api.yml"
echo "......................................................................"

echo "Comenzando a crear la imagen para la API ...."
sudo docker-compose -f create_containers_for_services_of_image_api.yml up -d

sudo docker logs -f $container_name_image_container_api

echo "......................................................................"
echo "Se termino de levantar el servicio create_containers_for_services_of_image_api, sí muestra el siguiente mensaje"
echo "Setting up zip (3.0-13)"
echo "......................................................................"
echo "Eliminar el archivo create_imagen_for_the_api2.yml ...."
rm create_containers_for_services_of_image_api.yml